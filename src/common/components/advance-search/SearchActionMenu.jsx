...
import { rem, Tooltip, ActionIcon, Box } from "@mantine/core";
import { useTranslation } from "react-i18next";
import { IconFileTypeXls, IconFilter, IconPdf, IconRestore, IconSearch } from "@tabler/icons-react";
import { useHotkeys } from "@mantine/hooks";
import { useDispatch, useSelector } from "react-redux";
import { setFetching, setInvoiceBatchFilterData } from "../../../app/store/inventory/crudSlice.js";
import _FilterSearch from "../modules/inventory/invoice-batch/drawer/_FilterSearch.js";
import __FilterPopover from "../modules/inventory/product/__FilterPopover.js";
			...
			<Box>
				<ActionIcon.Group justify="center">
					<ActionIcon
						...
						aria-label="Filter"
						onClick={() => {
							invoiceBatchFilterData.searchKeyword.length > 0 ||
							invoiceBatchFilterData.customer_id ||
							invoiceBatchFilterData.start_date
