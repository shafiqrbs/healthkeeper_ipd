...
export default function _Table({ module, open }) {
    ...
    const handleEntityEdit = (id) => {
        ...
        dispatch(
            editEntityData({
                url: `${MASTER_DATA_ROUTES.API_ROUTES.DOSAGE.VIEW}/${id}`,
                module,
            })
        );
        navigate(`${MASTER_DATA_ROUTES.NAVIGATION_LINKS.DOSAGE.INDEX}/${id}`);
    };
    ...
    const handleDeleteSuccess = async (id) => {
        const res = await dispatch(
            deleteEntityData({
                url: `${MASTER_DATA_ROUTES.API_ROUTES.DOSAGE.DELETE}/${id}`,
                module,
                id,
            })
        );
        ...
        if (deleteEntityData.fulfilled.match(res)) {
            ...
            navigate(MASTER_DATA_ROUTES.NAVIGATION_LINKS.DOSAGE);
