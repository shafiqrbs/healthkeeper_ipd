						...
						<Box p={"md"} className="boxBackground borderRadiusAll" h={height}>
							<Box>
								<Grid columns={24}>
									...
									<Grid.Col span={"auto"}>
										{userObject && userObject.name && userObject.name}
									</Grid.Col>
								</Grid>
								<Grid columns={24}>
									<Grid.Col span={"8"} align={"left"} fw={"600"} fz={"14"}>
									...
									<Grid.Col span={"1"}>:</Grid.Col>
									<Grid.Col span={"auto"}>
										{userObject && userObject.username && userObject.username}
									</Grid.Col>
								</Grid>
								<Grid columns={24}>
									<Grid.Col span={"8"} align={"left"} fw={"600"} fz={"14"}>
									...
									<Grid.Col span={"1"}>:</Grid.Col>
									<Grid.Col span={"auto"}>
										{userObject && userObject.mobile && userObject.mobile}
									</Grid.Col>
								</Grid>
								...
								<Grid columns={24}>
									...
									<Grid.Col span={"1"}>:</Grid.Col>
									<Grid.Col span={"auto"}>
										{userObject && userObject.email && userObject.email}
									</Grid.Col>
								</Grid>
							</Box>
						</Box>
