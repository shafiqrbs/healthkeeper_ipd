...
import { IconCategoryPlus, IconCheck, IconDeviceFloppy, IconPencilBolt, IconPlus } from "@tabler/icons-react";
											...
											<Box>
												...
												<Box mt={"8"}>
													<SelectForm
														...
														value={
															settingTypeData
																? String(settingTypeDropdown)
																: entityEditData.setting_type_id
																? String(entityEditData.setting_type_id)
																: null
														}
