...
import { updateEntityData, editEntityData } from "@/app/store/core/crudThunk.js";
...
function DomainUpdateForm() {
	...
	const [productTypeChecked, setProductTypeChecked] = useState(
		Array.isArray(entityEditData?.product_types)
														...
														<SelectForm
															...
															value={
																businessModelId
																	...
																	: entityEditData.business_model_id
																	? String(entityEditData.business_model_id)
																	: null
															}
