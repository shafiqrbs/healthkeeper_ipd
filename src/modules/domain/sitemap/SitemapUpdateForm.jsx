...
import { Button, rem, Flex, Grid, Box, ScrollArea, Group, Text, Title, Alert, List, Stack } from "@mantine/core";
			...
			<Grid columns={9} gutter={{ base: 8 }}>
				...
				<Grid.Col span={1}>
					<Box bg={"white"} className={"borderRadiusAll"} pt={"16"}>
						<Shortcut form={form} FormSubmit={"EntityFormSubmit"} Name={"CompanyName"} />
					</Box>
				</Grid.Col>
			</Grid>
		</Box>
